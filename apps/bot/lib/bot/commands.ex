defmodule Bot.Commands do
  ...
  command ["hello", "hi"] do
    ...
    # macro `send_message/2` defined at Bot.Commander, it is
  ...
  command "question" do
    ...
    {:ok, _} = send_message "What's the best JoJo?",
      # Nadia.Model is aliased from Bot.Commander
      #
  ...
  # use.
  #
  # If you search for `defmacro send_message` at Bot.Commander, you'll see an
